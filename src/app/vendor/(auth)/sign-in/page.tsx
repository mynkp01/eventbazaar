...
const SignIn = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (Object.keys(newErrors).length === 0) {
        ...
        const reCaptchaToken = await executeRecaptcha("vendorLogin");
        try {
          const res = await apiHandler.vendor.vendorSignIn({
            ...details,
  ...
  const onClickSignIn = (e) => {
    if (
      (!isEmpty(userType) || !isEmpty(adminUserType)) &&
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <div className="flex h-full w-screen flex-col justify-center rounded-[20px] bg-white p-4 shadow-loginContainerShadow xs:w-full xs:p-10 sm:w-[70vw] md:w-[60vw] lg:w-[40vw] lg:p-16 xl:w-[40vw]">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-14-600 mt-5 text-center font-light lg:text-left">
