...
import { EventTypeAndVertical } from "@components/ProfileTabsInfo";
...
const Profile = () => {
  ...
  return (
    <div className="flex h-full flex-1 flex-col gap-4">
      <h3 className="heading-40">Manage Subscriptions</h3>
      <div className="h-full rounded-xl bg-primary-100 p-2 sm:p-3 lg:p-6">
